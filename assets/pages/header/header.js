document.write('\
		...
		<div class="topHeader">\
<!-- 			<a href="#">\
				<img id="logo" src="https://sites.google.com/site/aspebcchapter/_/rsrc/1374197438320/config/bc_colorweb%20-%2075.jpg">\
			</a>  --> \
			<div class="jumbotron">\
					<!-- add a link back to this page -->\
					<h2 id="welcome">Welcome to</h2>\
					<h1 id="content">ASPE BRITISH COLUMBIA CHAPTER</h1>\
					<h5 id="note"> Chapters are not authorized to speak for the Society </h5>\
			</div>\
		</div>\
\
		<!-- navigation bar -->\
